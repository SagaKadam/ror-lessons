...
class Employee
    include Destructable #including the destructable module
    def initialize(name)
    ...
    def self.identify_yourself #using a class method
...
puts Employee.identify_yourself #calling class method

employee1.destroy("myname") #calling a module method